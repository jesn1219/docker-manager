...
docker run -it --gpus all -v /tmp/.X11-unix:/tmp/.X11-unix -v /home/your_user/.Xauthority:/root/.Xauthority -e DISPLAY=$DISPLAY -p 60061:6006 -p 22001:22 -p 22002:22002 -p 22003:22003 jesn1219/beta bash
